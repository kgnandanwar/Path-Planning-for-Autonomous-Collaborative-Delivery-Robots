...
class MusketeersApp(MDApp):
    ...
    def __init__(self, **kwargs):
        super(MusketeersApp, self).__init__(**kwargs)
        ...
        menu_items = [
            {
                ...
                "text": "Base#{i+1}",
                "height": dp(56),
                "on_release": lambda x="Base#{i+1}": self.set_item(x),
            } for i in range(4)
        ]
        ...
        delivery_items = [
            {
                ...
                "text": "Pickup",
                "height": dp(56),
                "on_release": lambda x="Pickup": self.set_delivery(x),
            },
            {
                "viewclass": "IconListItem",
                "icon": "robot",
                "text": "Delivery",
                "height": dp(56),
                "on_release": lambda x="Delivery": self.set_delivery(x),
            } 
        ]
    ...
    def set_item(self, text_item):
        ...
        if(text_item == "Base#1"):
            robot_items = [
            {
                ...
                "text": "Husky#{i+1}",
                "height": dp(56),
                "on_release": lambda x="hsk#{i+1}": self.set_robot(x),
            } for i in range(5)
        ]
            ...
            robot_items = [
            {
                ...
                "text": "Husky#{i + 6}",
                "height": dp(56),
                "on_release": lambda x="hsk#{i + 6}": self.set_robot(x),
            } for i in range(5)
        ]
            self.robot_menu = MDDropdownMenu(
            caller=self.screen.ids.robot_item,
            ...
            robot_items = [
            {
                ...
                "text": "Husky#{i + 11}",
                "height": dp(56),
                "on_release": lambda x="hsk#{i + 11}": self.set_robot(x),
            } for i in range(5)
        ]
            self.robot_menu = MDDropdownMenu(
            caller=self.screen.ids.robot_item,
            ...
            robot_items = [
            {
                ...
                "text": "Husky#{i + 16}",
                "height": dp(56),
                "on_release": lambda x="hsk#{i + 16}": self.set_robot(x),
            } for i in range(5)
        ]
            self.robot_menu = MDDropdownMenu(
            caller=self.screen.ids.robot_item,
    ...
    def set_delivery(self, delivery_type):
        ...
        if(delivery_type == "Pickup"):
            location_items = [
            {
                ...
                "text": "Chipottle",
                "height": dp(56),
                "on_release": lambda x="Chipottle": self.set_location(x),
            },
            {
                "viewclass": "IconListItem",
                "icon": "robot",
                "text": "Subway",
                "height": dp(56),
                "on_release": lambda x="Subway": self.set_location(x),
            },
            {
                "viewclass": "IconListItem",
                "icon": "robot",
                "text": "Taco",
                "height": dp(56),
                "on_release": lambda x="Taco": self.set_location(x),
            },
            {
                "viewclass": "IconListItem",
                "icon": "robot",
                "text": "Panda Express",
                "height": dp(56),
                "on_release": lambda x="Panda Express": self.set_location(x),
            } 
        ]
            ...
            location_items = [
            {
                ...
                "text": "Iribe",
                "height": dp(56),
                "on_release": lambda x="Iribe": self.set_location(x),
            },
            {
                "viewclass": "IconListItem",
                "icon": "robot",
                "text": "JMP",
                "height": dp(56),
                "on_release": lambda x="JMP": self.set_location(x),
            },
            {
                "viewclass": "IconListItem",
                "icon": "robot",
                "text": "Domain",
                "height": dp(56),
                "on_release": lambda x="Domain": self.set_location(x),
            },
            {
                "viewclass": "IconListItem",
                "icon": "robot",
                "text": "McKeldin",
                "height": dp(56),
                "on_release": lambda x="McKeldin": self.set_location(x),
            } 
        ]
            self.location_menu = MDDropdownMenu(
            caller=self.screen.ids.location_item,
